        ...
        if (selectedStatement == null) {
            ...
            try {
                ...
                PrgState prg1 = new PrgState(new MyStack<IStmt>(), new MyDictionary<String, Value>(), new MyList<Value>(),
                        new FileTable<String, BufferedReader>(), new Heap(), new MyToySemaphoreTable(),selectedStatement);
        ...
        IStmt ex9 = new CompStmt(
                ...
                new CompStmt(
                        ...
                        new CompStmt(
                                ...
                                new CompStmt(
                                        new NewSemaphoreStatement("cnt", new ReadHeapExp(new VarExp("v1")), new ValueExp(new IntValue(1))),
                                        new CompStmt(
                                                new ForkStmt(
                                                        new CompStmt(
